...
namespace BulletExpress.Projectiles.Melee.Halberd
{
    public class ChlorophyteHalberd : ModProjectile, ILocalizedModType
    {
        ...
        public override void ModifyHitNPC(NPC target, ref NPC.HitModifiers modifiers)
        {
            ...
            modifiers.SourceDamage *= 0.2f + Main.player[Projectile.owner].velocity.Length() / 7f * 0.9f;
        }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            Main.player[Projectile.owner].AddBuff(ModContent.BuffType<IDA.Buffs.Bless.JyoratBless>(), 120);
