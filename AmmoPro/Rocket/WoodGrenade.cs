...
{
    public class WoodGrenade : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Dust d = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Smoke, 0f, 0f, 0, default, 1f);
                d.noGravity = true;
                d.velocity *= 0f;
            }
        }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int j = 0; j < 8; j++)
            {
                ...
                Dust dI = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Torch, 0f, 0f, 100, default, 2.5f);
