namespace BulletExpress.Weapons.Ranged.Ter
{
	public class KnifeDance : ModItem, ILocalizedModType
    {
        ...
        {
            Projectile.NewProjectileDirect(source, position, velocity, ModContent.ProjectileType<Projectiles.Ranged.CurseFlamingBlade>(), damage * 3, knockback, player.whoAmI);
            //如果主射弹为，则更改为
