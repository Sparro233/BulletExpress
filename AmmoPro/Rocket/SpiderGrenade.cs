...
{
    public class SpiderGrenade : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                Projectile child = Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), Projectile.Center, v, ProjectileID.BabySpider, Projectile.damage * 2, Projectile.knockBack, Main.myPlayer, 0, 1);
            }
