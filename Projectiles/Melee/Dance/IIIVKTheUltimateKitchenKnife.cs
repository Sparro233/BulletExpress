...
{
    public class IIIVKTheUltimateKitchenKnife : ModProjectile, ILocalizedModType
    {
        ...
        {
            ProjectileID.Sets.AllowsContactDamageFromJellyfish[Type] = true;//攻击水母触电
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color backDarkColor = new Color(255, 250, 205);
            Color middleMediumColor = new Color(255, 215, 0);
            Color frontLightColor = new Color(255, 215, 0);
