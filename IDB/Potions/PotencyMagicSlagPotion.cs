...
{
    public class PotencyMagicSlagPotion : ModItem, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = (ModContent.BuffType<IDA.Buffs.Potion.PotencyMagicSlagPotion>());
            Item.buffTime = 25000;
        ...
        public override void AddRecipes()
        {
            ...
            .AddIngredient(ModContent.ItemType<MagicSlagPotion>(), 2)
