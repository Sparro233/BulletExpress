...
{
    public class DeepSeaDagger : ModProjectile, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            //射弹可以击中目标的最大射程。300 像素是 18.75 个图块
            Projectile.ownerHitCheckDistance = 300f;
            //使用近战无敌帧,这会导致射弹和武器本身互相骗伤
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            // Flip the sprite based on the direction it is facing
            ...
            //射弹主颜色
            Color backDarkColor = new Color(60, 100, 120);
            Color middleMediumColor = new Color(30, 200, 210);
            Color frontLightColor = new Color(60, 80, 200);
