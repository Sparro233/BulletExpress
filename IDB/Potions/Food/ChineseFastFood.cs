...
{
    public class ChineseFastFood : ModItem, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = (ModContent.BuffType<IDA.Buffs.Food.MicroChocolate>());
            Item.buffTime = 50000;
        ...
        public override void AddRecipes()
        {
            ...
            .AddIngredient(ModContent.ItemType<IDB.Materials.Flour>())
            .AddTile(13)
            .Register();
        }
    }
