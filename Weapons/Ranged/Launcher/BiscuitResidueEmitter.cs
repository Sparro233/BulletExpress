...
{
	public class BiscuitResidueEmitter : ModItem, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
			...
			Item.shoot = ModContent.ProjectileType<AmmoPro.Rocket.Cookie.Cookie>(); 
            Item.shootSpeed = 7f;
            Item.scale = 1f;
        ...
        public override void ModifyShootStats(Player player, ref Vector2 position, ref Vector2 velocity, ref int type, ref int damage, ref float knockback)
        {
            ...
            {
                type = ModContent.ProjectileType<AmmoPro.Rocket.Cookie.Cookie>();
                damage *= 2;
            }
        }
