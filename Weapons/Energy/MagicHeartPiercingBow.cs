...
{
	public class MagicHeartPiercingBow : ModItem, ILocalizedModType
    {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < Pro; i++)
                {
                    Vector2 v = velocity.RotatedByRandom(MathHelper.ToRadians(18));
        ...
        {
            CreateRecipe()
            .AddIngredient(ModContent.ItemType<IDB.Materials.MagicBar>(), 14)
